  ...
  return (
    <html lang="ru" className={inter.variable}>
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,300;12..96,400;12..96,500;12..96,600;12..96,700&family=Newsreader:ital,wght@1,300;1,400&display=swap"
          rel="stylesheet"
        />
        <script
